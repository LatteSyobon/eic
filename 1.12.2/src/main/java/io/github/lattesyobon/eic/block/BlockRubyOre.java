...
public class BlockRubyOre extends ElementsEic.ModElement {
	@GameRegistry.ObjectHolder("eic:rubyore")
	public static final Block block = null;
	public BlockRubyOre(ElementsEic instance) {
		super(instance, 17);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("eic:rubyore", "inventory"));
	}
