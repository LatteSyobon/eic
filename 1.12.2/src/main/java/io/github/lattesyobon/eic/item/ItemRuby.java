...
public class ItemRuby extends ElementsEic.ModElement {
	@GameRegistry.ObjectHolder("eic:ruby")
	public static final Item block = null;
	public ItemRuby(ElementsEic instance) {
		super(instance, 1);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("eic:ruby", "inventory"));
	}
