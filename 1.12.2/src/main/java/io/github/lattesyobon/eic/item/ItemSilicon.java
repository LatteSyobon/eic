...
public class ItemSilicon extends ElementsEic.ModElement {
	@GameRegistry.ObjectHolder("eic:silicon")
	public static final Item block = null;
	public ItemSilicon(ElementsEic instance) {
		super(instance, 24);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("eic:silicon", "inventory"));
	}
