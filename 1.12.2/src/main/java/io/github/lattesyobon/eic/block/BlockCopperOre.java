...
public class BlockCopperOre extends ElementsEic.ModElement {
	@GameRegistry.ObjectHolder("eic:copperore")
	public static final Block block = null;
	public BlockCopperOre(ElementsEic instance) {
		super(instance, 16);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("eic:copperore", "inventory"));
	}
